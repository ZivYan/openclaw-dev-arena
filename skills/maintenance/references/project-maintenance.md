...
> 本文档指导如何维护和更新 openclaw-dev-arena 项目本身。
...
- ❌ **内部 Agent 名称用于非示例场景**（示例中用 `<agent_id>` 占位，教程中的通用角色名如 coder/orchestrator 可保留）
...
- **教程角色名可保留**：momo、orchestrator、coder 等作为示例角色是通用的，但不要暴露真实 Agent 的具体配置
